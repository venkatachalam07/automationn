...
public class OldProfileingMethod extends Base {


    public static void venkatBlProfile(Long phoneNumber,String otpUat, String panNumber) throws InterruptedException {

        chromeBrowser();
        urlLaunch("https://qa-cmol1.creditmantri.co.in/business-loan/");
        time();
        maximize();
        ...
        email.sendKeys("Venbgyfdfdfsssshhggabu@2001gmail.com");
     ...
     //   WebElement city = driver.findElement(By.xpath("//img[@src='https://cm-cdn-postlogin.creditmantri.com/offers/bundle/chennai-select.png']"));
        ...
        WebElement yearse=driver.findElement(By.xpath("//li[text()='Before 2019']"));
    ...
    public static void KasiBlProfile() throws InterruptedException {

        chromeBrowser();
        urlLaunch("https://www.creditmantri.com/business-loan/");
       time();
        maximize();
        WebElement CEB=driver.findElement(By.xpath(" (//a[text()='CHECK ELIGIBILITY'])[1]"));
        javaClick(CEB);
        ...
        email.sendKeys("kasikasisdkjshdddddsds@gmail.com");

        WebElement phone = driver.findElement(By.xpath("//input[@id='otp-mobile']"));
        javaClick(phone);
        phone.sendKeys("8754653501");
        ...
        Homescreen();
        WebElement pan=driver.findElement(By.xpath("//input[@name=\"pan\"]"));pan.click();
        sendKeys(pan,"CJJPK3780M");


        WebElement Fistname=driver.findElement(By.xpath("//input[@name=\"first-name\"]"));Fistname.click();
        sendKeys(Fistname,"GOVIDHAN");



        WebElement Lastname=driver.findElement(By.xpath("//input[@name=\"last-name\"]"));Lastname.click();
        sendKeys(Lastname,"KASI R");



        WebElement state=driver.findElement(By.xpath("//span[text()='Select State']"));state.click();
    ...
    public static void PaviBlProfile() throws InterruptedException {
        ...
        email.sendKeys("pavipavipavipavi@gmail.com");

        WebElement phone = driver.findElement(By.xpath("//input[@id='otp-mobile']"));
        javaClick(phone);
        phone.sendKeys("9790766456");
    ...
    public static void RagaBlProfile() throws InterruptedException {
        ...
        email.sendKeys("Raggamalikaaaaaaaa@gmail.com");

        WebElement phone = driver.findElement(By.xpath("//input[@id='otp-mobile']"));
        javaClick(phone);
        phone.sendKeys("6381270159");
        ...
        WebElement pincode=driver.findElement(By.xpath("//input[@name='residentialPincode']"));pincode.click();
        pincode.sendKeys("600017");


        WebElement BPIN=driver.findElement(By.xpath("//input[@name='businessPincode']"));BPIN.click();
        BPIN.sendKeys("600017");
   ...
   venkatBlProfile(6380520530L, "30714","HCHPP6417A");
